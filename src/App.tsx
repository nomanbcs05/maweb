      ...
      <footer className="bg-[#2f2626] text-white py-12 sm:py-16 px-4 sm:px-6 border-t border-[#D4AF37]/30 shadow-2xl relative">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12 sm:mb-16">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-3">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-9 h-9 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white hover:bg-[#D4AF37] hover:text-[#2f2626] hover:border-[#D4AF37] transition-all"
                  aria-label="Facebook"
                >
            ...
            {/* Contact Section */}
            <div>
              <h4 className="text-sm font-bold uppercase tracking-wider text-[#D4AF37] mb-4 border-b border-white/10 pb-2">Contact</h4>
              <ul className="space-y-3 text-gray-300 text-xs sm:text-sm font-medium">
                ...
                <li>
                  <a href="tel:+923297040402" className="flex items-center gap-2 hover:text-[#D4AF37] transition-colors">
                    <span className="text-[#D4AF37]">📞</span> +92 329 7040 402
                  </a>
                </li>
                <li>
                  <a
                    href="https://maps.app.goo.gl/xa8UAj57MnsVeYbw5"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-2 hover:text-[#D4AF37] transition-colors"
                  >
                    <span className="text-[#D4AF37] mt-0.5">📍</span>
                    <span>Dharma Road Main Factory Gate, Nawabshah</span>
                  </a>
                </li>
                <li>
                  <a
                    href="https://wa.me/923297040402"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 hover:text-[#25D366] transition-colors"
                  >
                    <svg width="15" height="15" fill="currentColor" className="text-[#25D366] flex-shrink-0" viewBox="0 0 24 24">
              ...
              <div className="bg-white/5 border border-white/15 rounded-2xl p-5 shadow-xl backdrop-blur-sm">
                ...
                <form
                  ...
                  onSubmit={async (e) => {
                    ...
                    try {
                      await emailjs.send(
                        import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_mabakers',
                        import.meta.env.VITE_EMAILJS_TEMPLATE_ID || 'template_contact',
                        { from_name: contactName, from_email: contactEmail, to_email: 'mabakersofficials@gmail.com' },
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 bg-[#D4AF37] text-[#071326] text-xs font-bold uppercase tracking-wider rounded-lg hover:bg-yellow-400 transition-all shadow-md cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                  >
